...
namespace OwinAndKatanaTry
{
    ...
    {
        public GetHandler(IDictionary<string, object> env, IEnumerable<MyAppRoute> routes)
            : base(env, routes)
        { }
        ...
        public async override Task<object> Handle()
        {
            ...
            var view = await base.InvokeController(route.Controller, controllerAndAction[1]);
            if (view == null)
